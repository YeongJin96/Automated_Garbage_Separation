...
class pub_to_dofbot:
    def __init__(self):
        ...
        # self.ready1 = [-1.23, -0.0, -0.66, -1.57, 0.0, -1.50]
    ...
    # def move_arm(self):
    #     sleep(10.0)
    #     self.joint_state.position = [0.0, -0.72, -1.0, -1.25, 0.0]
    #     self.pub.publish(self.joint_state)
    #     sleep(1.0)
        
    #     self.joint_state.position[3] =  0.25
    #     self.pub.publish(self.joint_state)
    #     sleep(1.5)
        
    #     self.joint_state.position = self.ready1
    #     self.pub.publish(self.joint_state)
    #     sleep(1.5)
